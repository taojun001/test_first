...
<body>
<p align="center">添加新闻</p>
<table width="800" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#6699CC">
<form id="form1" name="form1" method="post" action="admin_news_add_code.php">
  <tr>
    <td width="109" height="35" align="right" bgcolor="#FFFFFF">所属类别：</td>
    <td width="684" height="35" align="left" bgcolor="#FFFFFF">
	...
	{
	?>
      <option value="<?php echo $rs['newscategoryid'] ?>"><?php echo $rs['newscategory'] ?></option>
    <?php 
	}
	?> 
    </select>
  ...
  <tr>
    ...
    <td height="35" align="left" bgcolor="#FFFFFF"><input type="text" name="title" id="title" /></td>
  </tr>
  <tr>
    <td height="35" align="right" bgcolor="#FFFFFF">新闻内容：</td>
    <td height="35" align="left" bgcolor="#FFFFFF"><textarea name="content" id="content" cols="92" rows="20"></textarea></td>
  </tr>
  <tr>
